	...
	resources: {
		en: {
			translation: {
				...
				forgotPasswordDescription: "Enter your phone number to receive a verification code",
				sendCode: "Send Code",
		...
		uz: {
			translation: {
				...
				forgotPasswordDescription: "Tasdiqlash kodini olish uchun telefon raqamingizni kiriting",
				sendCode: "Kod jo'natish",
				enterVerificationCode: "Tasdiqlash kodini kiriting",
				enterCode: "Tasdiqlash kodini kiriting",
				codeSentTo: "Kod jo'natildi",
				verify: "Tasdiqlash",
				verifying: "Tekshirilmoqda...",
				sending: "Jo'natilmoqda...",
				codeSentSuccess: "Tasdiqlash kodi muvaffaqiyatli jo'natildi!",
				codeVerifiedSuccess: "Kod muvaffaqiyatli tasdiqlandi!",
				invalidCode: "Noto'g'ri tasdiqlash kodi",
				errorSendingCode: "Tasdiqlash kodini jo'natishda xatolik",
				recaptchaExpired: "reCAPTCHA muddati tugadi. Qayta urinib ko'ring.",
				back: "Orqaga",
			},
		},
	},
